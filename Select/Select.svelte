<script lang="ts">
	...
	const processedOptions = options.filter((el, i) => {
		return options.indexOf(el) === i;
	});
...
<div class="custom-select-wrapper center" class:glow>
	<div class="custom-select">
		...
		<div class="options-container">
			{#each processedOptions as option}
				...
				<button
					class="option"
					class:selected={selected.toLowerCase() === option.toLowerCase()}
					on:click={onSelect}
				>
					{option}
				</button>
